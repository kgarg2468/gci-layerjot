...
Source: formatted from `CLABSI AR Build Guide v2.md`.
...
| Phase 4 (Unity) - WebSocket client, action_cmd parsing, HUD alert popups | Phase 5 (AI) - Offline LLM fallback, AI disclaimer, canned safety responses |
...
- [Phase 1: Core Unity App](#phase-1-core-unity-app)
- [Phase 2: XREAL Glasses Integration](#phase-2-xreal-glasses-integration)
- [Phase 3: AI Backend](#phase-3-ai-backend)
- [Phase 4: Full Integration](#phase-4-full-integration)
- [Phase 5: Polish & Safety](#phase-5-polish--safety)
...
## Phase 2: XREAL Glasses Integration
...
| Real-Time App Control | action_cmd schema -> consumed by Unity in Phase 4 |
